"""
generate_docx_v2.py
Convert paper02_draft_v1.md → paper02_draft_v3.docx

Changes from v1:
  - Three-line tables (top 1.5pt / header-bottom 0.75pt / bottom 1.5pt; no other borders)
  - Figures inserted after References (each on its own page, preceded by Figure Captions page)
  - *Note.* rendered as bold-italic per APA style
  - Normal style double-spacing applied correctly (remove-before-add pattern)
"""
...
docx_path   = os.path.join(script_dir, "paper02_draft_v3.docx")
