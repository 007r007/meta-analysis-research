...
# 分组：(表头背景色, 数据行底色, 分组标签)
# 表头用oo的浅色方案（可读性好），数据行保留浅底色辅助定位
GROUP = {
    'ID':    ('595959', 'F2F2F2', '文献标识'),
    'INFO':  ('2E75B6', 'DEEAF1', '研究基本信息'),    # oo: BDD7EE表头 → 用稍深蓝
    'TRAIN': ('548235', 'E2EFDA', '训练特征'),         # oo风格浅绿
    'TRANS': ('C55A11', 'FCE4D6', '迁移结局'),         # oo风格橙
    'NEURO': ('7030A0', 'EAD1F5', '神经影像结局'),     # 紫
    'MOD':   ('B8860B', 'FFF2CC', '调节因素'),         # 金黄，比深棕更清晰
    'NOTE':  ('595959', 'F2F2F2', '备注'),
}
